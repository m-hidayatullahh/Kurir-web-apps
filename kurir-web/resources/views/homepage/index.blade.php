            ...
            <div class="row align-items-center content">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="cta-buttons" data-aos="fade-up" data-aos-delay="300">
                        <a href="{{ url('/order') }}" class="btn btn-primary">Pesan Sekarang</a>
                        <a href="{{ url('/cek-resi') }}" class="btn btn-outline">Lacak Kiriman</a>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="hero-image">
                        <img src="{{ asset('assets/img/hero-2.png') }}" alt="Kurir Becat NTB" class="img-fluid"
                            data-aos="zoom-out" data-aos-delay="300" style="width: 300%; height: auto;" />
